...
|------|-------|----------------|------|
| Free | 5/day, burst 2 | None | $0 |
| Pro | Unlimited* | +0.05 similarity boost to all anchors | $5/mo |

*Pro "unlimited" = token bucket of 5 (burst 5, refill 1/5min, ~288/day theoretical max). Free = 5 tokens/day, bucket size 2 (can post 2 in a row, then wait). We want paid users to post a lot.
...
| Publish | 5/day (bucket size 2) | Unlimited* | Free: 5 tokens/day, burst 2. Pro: bucket 5, refill 1/5min |
