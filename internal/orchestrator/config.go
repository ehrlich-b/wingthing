...
// ResolveConfig applies precedence: skill frontmatter > agent defaults > config.yaml defaults.
// Pass sk=nil for ad-hoc (non-skill) tasks.
func ResolveConfig(sk *skill.Skill, agentIsolation string, cfg *config.Config) ResolvedConfig {
	rc := ResolvedConfig{
